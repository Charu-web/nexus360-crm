import{l as ae,u as le,r as s,j as e,a as re,P as de,S as oe,C as I,X as ne,M as ie,s as B,n as Modal}from"./index-CMn9DqN2.js";
...
function LeadsPage() {
  ...
  const fetchLeads = () => {
    ...
    getLeads({
      ...
      if (res && res.success) {
        const items = Array.isArray(res.data) ? res.data : (Array.isArray(res.leads) ? res.leads : []); setLeads(items);
      }
                      ...
                      e.jsxs("td", {
                        ...
                        children: [
                          e.jsxs("div", {
                            ...
                            children: [
                              e.jsx("span", { className: "font-black text-slate-900 dark:text-white hover:text-indigo-600 transition", children: l.name || l.customerName || "New Lead" }),
