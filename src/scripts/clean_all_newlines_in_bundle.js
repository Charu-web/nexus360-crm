...
try {
  new vm.Script(code);
  console.log('====================================================');
  console.log(' [PASS] Node VM compiled index-CMn9DqNx.js with 0 SYNTAX ERRORS!');
  console.log('====================================================');
} catch (err) {
